...
- [ ] **Eagle 32×32 sprite size**. ROM eagle is 8 OAM entries = 4×2 grid of 8×16 sprites = 32×32px. Web draws 2×2 BG metatile = 16×16px. Tiles: intact $D1–$DF, damaged $E1–$EF from PT1/BG bank (odd OAM → T&$FE, no +256). (REVERSE.md line 2524, items 5+6)
