...
- [ ] **Alt CHR bank border tile $00 is decorative, not blank**. Default bank tile $00 = all-black (invisible border). Alt bank (stages 3,9,10,12,13) tile $00 = gray/dark-red cobblestone pattern (colors 2+3). With BG0 palette this renders as visible #540400/#545454 pattern in the border area. Need to verify whether ROM actually shows decorative borders on these stages or uses a different blank tile.
