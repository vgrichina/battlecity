...
- [ ] **Stage-clear tally screen: verify positions + animation timing against ROM**. Per-type row layout, score drain rate, and final totals position need ROM nametable audit. Current implementation is approximate. (ROM $CAF1 StageClearTallyScreen, REVERSE.md line 2527)
