...
- [ ] **HUD sidebar column alignment**. ROM sidebar occupies nametable cols 27–31 (pixel X 216–255, 40px wide). Web computes `hx = FX + GW*META + 6 = 230` which is col 28.75 (only 26px to screen edge). Should be col 27 = pixel 216 for accurate alignment. (REVERSE.md line 1818)
