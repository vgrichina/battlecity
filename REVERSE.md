...
- [ ] **Title screen: verify copyright text + mode select positions against ROM**. "NAMCO 1985" at (80,126) and "1 PLAYER"/"2 PLAYERS" at (88,142)/(88,158) are web approximations; need ROM nametable verification for exact col/row placement. (ROM $CFAA PreGameDraw)
