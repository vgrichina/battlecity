...
- [ ] **Enemy icon erased slots should draw tile $11**. ROM `DrawHUDKillIconB ($C7AE)` writes tile $11 (blank/steel) when enemy spawns, erasing the icon from bottom-right to top-left. Web just doesn't draw anything for empty slots. (REVERSE.md line 1827–1829)
