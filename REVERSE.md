...
- [ ] **Game-over hi-score flash: use RNG palette instead of sequential cycling**. ROM `NewHiScoreDisplay ($C4E9)` uses `QueuePaletteWrite` with RNG-driven palette index. Web cycles sequentially `(frameCount >> 2) & 7`. (REVERSE.md line 1673–1676)
