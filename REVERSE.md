...
- [ ] Disassemble DrawGameOverScreen ($C44D–$C4D0+) — partial trace found: draws nametable strings from $D291 and $D145; confirm full sequence, what tiles are written, and return condition
- [ ] Decode text strings at $D291 and $D145 — raw bytes; determine encoding (ASCII, tile indices, or length-prefixed); used by DrawGameOverScreen ($C44D)
- [ ] Disassemble ControllerDoubleRead ($99D2) — NES $4016/$4017 latch+read loop; callers at $85C0 and $8650; confirm how 8 bits are packed into $06 (P1Dir) / $07 (P2Dir)
