...
- [ ] **Score leading-zero suppression (SkipLeadingZeros $D9A7)**. ROM score display skips leading zero digits; web pads with '0' via `padStart(6,'0')`. Should blank-pad or trim leading zeros for ROM-accurate display. (REVERSE.md line 671)
