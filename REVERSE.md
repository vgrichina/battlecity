...
- [ ] **HUD bouncing tank animation ($C7F8)**. ROM draws 2 OAM sprites (tiles $79/$7D, palette SP3) at RAM $0105/$0106 with 4-direction wiggle ($D2C6/$D2CA) every frame while $0108≥$0A. Sprite hides at Y=$F0 when count reaches 0. Web has no equivalent animation. (REVERSE.md line 1862–1875)
